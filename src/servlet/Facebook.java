...
public class Facebook{	
	// 자신의 facebook appID
	public static final String APPID = "232795553517439";
	// 자신의 facebook app Secret;
	public static final String APPSECRET = "3185c98c7533b44cf317c551901a3f6d";
	// facebook에 등록시킬 사이트주소
	public static final String SITEURL="http://localhost:8080/book";
