		...
		<table class="table table-striped table-bordered">
			<tr>
				<td rowspan="8" class="row-align">
					<img src="https://graph.facebook.com/${me.id}/picture?type=square" class="img-polaroid" />
				</td>
			...
			<tr>
				<td>ID :</td><td>${me.id} and <%=session.getAttribute("userid") %> </td>
			</tr>
			<tr>
			<td>sessionid: ${sessionScope.userid} </td>
			</tr>
			<tr>
